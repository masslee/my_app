...
""")
# La fonction markdown permet de rajouter du texte à défaut il ajoute du texte simple. unsafe_allow_html=True permet de 


# Fonction de loading des données
def load_(dataframe, title, key) : # la fonction "load" permet de monter le jeux de  donnée à chaque fois qo;on clique dessus
    st.markdown("""
    <style>
